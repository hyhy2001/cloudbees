...
export const SYSTEM_PROMPT = [
  ...
  "  - In markdown tables, NEVER use bare | inside a cell (it breaks column parsing). Use 'or' instead: write 'failed or success', not 'failed | success'.",
  "  - Cron expressions must be quoted: use `'H 0 * * *'` not plain H 0 * * *.",
