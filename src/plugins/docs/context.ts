...
export const SYSTEM_PROMPT = [
  ...
  "- When multiple commands match, prefer the FIRST one listed in the context (the highest-ranked BM25 match).",
  ...
  "  Bad answer: \"No info available — try `bee --help`\"",
  "  (Correct: if no install info, explain the closest match like login.)",
  "",
  "  Bad question: \"what is controlled agent\"",
  "  Bad answer: \"Use `bee help controlled-agent`\"",
  "  (`bee help` is not a real command. Use the commands from <info> block instead.)",
  "",
  "  Bad question: \"list all credentials with --all\"",
  "  Bad answer: \"`bee cred list --all`\"",
  "  (If `cred.list` has no <flag>--all</flag> in its block, do not suggest it.)",
].join("\n");
