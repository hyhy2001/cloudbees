...
def invalidate_resource_cache(resource_type: str, db_path=None):
    """Invalidate cache for a specific resource type (job, credential, node)."""
    if resource_type == "job":
        invalidate_prefix("jobs.", db_path)
    elif resource_type == "credential":
        invalidate_prefix("credentials.", db_path)
    elif resource_type == "node":
        invalidate_prefix("nodes.", db_path)
